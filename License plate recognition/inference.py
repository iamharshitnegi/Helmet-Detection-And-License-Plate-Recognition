...
class CarLicensePlateDetector:
    ...
    def recognize_license_plate(self, img_path: str) -> np.ndarray:
        ...
        for box in boxes:
            ...
            cv2.putText(img, license_plate, (x1, y1 - 20), font, font_scale, font_color, font_thickness)
...
if __name__ == '__main__':
    ...
    media_path: str = './images/cropped_image_0.jpg'  # Replace with the path to your image or video
    output_path: str = './images/yolov8_car.jpg'  # Replace with your output path, without file extension
